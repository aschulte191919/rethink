      ...
      <NavBarGroup>
        ...
        {admin ? (
          <>
            ...
            <Link href="my-wellness" passHref>
              <NavLink>wellness report</NavLink>
            </Link>
          </>
        ) : (
          <>
            <Link href={`/surveys/${subNav}`} passHref>
              <NavLink>surveys</NavLink>
            </Link>
            <Link href="/wellness-report" passHref>
              <NavLink>wellness report</NavLink>
            </Link>
          </>
        )}
